...
function orderMineListReducer(state = { orders: [] }, action) {
  switch (action.type) {
...
function orderListReducer(state = { orders: [] }, action) {
  ...
  export {orderCreateReducer, orderDetailsReducer, orderPayReducer, orderMineListReducer, orderListReducer, orderDeliverReducer}